...
public class EncryptionUtilsTest {
    ...
    public void testLoadDecryptionKey_ShouldSupportPkcs8Der(String keyLocation, String expectedEncoding) throws Exception {
    ...
    public void testLoadDecryptionKey_ShouldSupportPkcs1Base64Pem_512bits(String fileName) throws Exception {
