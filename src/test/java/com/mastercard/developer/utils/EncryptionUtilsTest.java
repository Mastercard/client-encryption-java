...
public class EncryptionUtilsTest {
    ...
    @Test
    public void testLoadDecryptionKey_ShouldSupportPkcs12_FromInputStream() throws Exception {

        // GIVEN
        InputStream inputStream = getClass().getResourceAsStream("/keys/pkcs12/test_key.p12");
        String keyAlias = "mykeyalias";
        String keyPassword = "Password1";

        // WHEN
        PrivateKey privateKey = EncryptionUtils.loadDecryptionKey(inputStream , keyAlias, keyPassword);
